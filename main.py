...
<div class="page nfeArea">
    <div class="boxFields" style="padding-top: 20px;">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        ...
                        <span class="bold block txt-center info">`{x}</span>
                    </td>
                </tr>
                <tr>
        ...
        <table cellpadding="0" cellspacing="0" class="boxDestinatario" border="1">
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <span class="nf-label">DATA DE ENTR./SA�DA</span>
                ...
                <tr>
                    ...
                    <td>
                        <span class="nf-label">HORA ENTR./SA�DA</span>
        ...
        <p class="area-name">Dados do produto/servi�o</p>
        <div class="wrapper-border">
            <table cellpadding="0" cellspacing="0" border="1" class="boxProdutoServico">
                <thead class="listProdutoServico" id="table">
                    <tr class="titles">
                        <th class="cod" style="width: 15.5mm">C�DIGO</th>
                        <th class="descrit" style="width: 66.1mm">DESCRI��O DO PRODUTO/SERVI�O</th>
            ...
            <tbody>
                <tr>
                    <td class="field inscrMunicipal">
                        <span class="nf-label">INSCRI��O MUNICIPAL</span>
                        <span class="info txt-center">[ds_company_im]</span>
                    </td>
                    <td class="field valorTotal">
                        <span class="nf-label">VALOR TOTAL DOS SERVI�OS</span>
                        <span class="info txt-right">[vl_total_serv]</span>
                    </td>
                    <td class="field baseCalculo">
                        <span class="nf-label">BASE DE C�LCULO DO ISSQN</span>
            ...
            <tbody>
                <tr>
                    <td class="field infoComplementar">
                        <span class="nf-label">INFORMA��ES COMPLEMENTARES</span>
...
pdfkit.from_string(str_pronta,"out.pdf",configuration=config)